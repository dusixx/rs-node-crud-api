...
import { startServer } from '../server/server.utils';
...
describe('GET /users/{id}', () => {
  it('should return exsisting user by id', async () => {
...
describe('POST /users', () => {
  ...
  it('should remove duplicate hobbies', async () => {
    const userData: UserCreate = { username: 'ab', age: 33, hobbies: ['AAA', 'aaa', 'bbb'] };
